...
namespace blog.Services
{
    public class BlogServices
    {
        ...
        //Find Async Searches by the Primary Key (aka our Id) We use this over SingleOrDefaultAsync Because it is more Efficient
        ...
        public async Task<List<BlogModel>> GetBlogsByCategoryAsync(string category) => await _dataContext.Blog.Where(blog => blog.Category == category).ToListAsync();
    }
}